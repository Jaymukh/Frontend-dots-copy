...
const StateMap: React.FC<StateMapProps> = ({
    ...
    const [selectedRegion, setSelectedRegion] = useState<{ isClicked: boolean, feature: any }>({ isClicked: false, feature: null });
        ...
        <div className='row margin-left-right-0'
            ...
            <div className='col-xl-9 col-lg-9 col-md-9 col-sm-9 col-9 margin-0 padding-0'>
                <div className='row margin-0 padding-0 h-100'>
                    ...
                    <div className='col-3 col-sm-3 col-md-4 col-lg-3 col-xl-3 padding-0' style={{ backgroundColor: '#F4F6F8', height: '80.25vh' }}>
                        <CoreSolutions
                            isChecked={isChecked}
                    ...
                    <div className='col-xl-9 col-lg-9 col-md-9 col-sm-9 col-9 padding-0' style={{ height: '80.25vh' }}>
                        {isLoaded &&
                            <GoogleMap
                                ref={mapRef}
                                zoom={6}
